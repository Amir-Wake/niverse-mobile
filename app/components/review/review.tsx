  ...
  return (
    <View style={styles.container}>
      <View style={styles.writeReview}>
        <TouchableOpacity style={{alignItems:'center', alignContent:'center'}} onPress={() => router.push(`/components/review/writeReview?bookId=${bookId}`)}>
          <Text style={{fontSize:16, textAlign:'center', fontWeight:'bold'}}>Leave or edit your review</Text>
      ...
      <View style={styles.writeReview}>
        <TouchableOpacity onPress={() => router.push(`/components/review/allReviews?bookId=${bookId}`)}>
          <Text style={{fontSize:16, textAlign:'center', fontWeight:'bold'}}>Read all reviews</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
