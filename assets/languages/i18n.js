...
const i18n = new I18n({
  en: {
    aboutApp: "This app is a free platform where individuals can freely share their books with others. It is a non-profitable service that allows users to upload their digital books and connect with readers. We offer a space for sharing and reading books.",
    new: "New",
  ...
  ku: {
    aboutApp:"ئەم بەرنامەیە سەکۆیەکەی سەربەخۆیە کە تاکەکان دەتوانن بە ئازادی کتێبەکانی خۆیان لەگەڵ ئەوانی تر هاوبەشی پێبکەن. ئەمە خزمەتگوزارییەکی قازانج نەویستە کە ئێمە شوێنێک بۆ پاراستن و دابینکردنی کتێبە دیجیتاڵیەکان لە نێوان نوسەر و خوێنەردا دابین دەکەین.",
    new: "نوێ",
